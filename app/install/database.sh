...
sqlite3 init.sqlite3  "CREATE TABLE domain (id INTEGER PRIMARY KEY, name TEXT, dir_name TEXT, domain_id TEXT, db_name TEXT, db_user TEXT, db_password TEXT, created_dt TEXT);"
